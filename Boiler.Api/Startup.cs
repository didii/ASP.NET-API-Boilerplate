    ...
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddSwaggerGen(cfg => {
                ...
                cfg.IncludeXmlComments(@"..\xmlDocs\Boiler.Api.xml");
                cfg.IncludeXmlComments(@"..\xmlDocs\Boiler.Business.xml");
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(cfg => cfg.SwaggerEndpoint("/swagger/v1/swagger.json", "Boiler API V1"));
